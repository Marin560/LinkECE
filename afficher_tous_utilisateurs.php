...
<head>
    ...
    <body>
        <nav class="navbar navbar-default" id="tabcol">
            <div class="container-fluid">
                ...
                <li class="active"><a href="afficher_tous_utilisateurs.php"><span class="glyphicon glyphicon-search "></span>Rechercher un User</a></li>
    ...
    <div class="container text-center">
		...
		<div class="row">
            ...
            <?php include ("affichage_utilisateurs.php"); ?>
